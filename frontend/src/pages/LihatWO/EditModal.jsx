...
export const EditModal = ({
    item, onClose, onSave, allSektorOptions, getSektorForWorkzone,
    getWorkzonesForSektor, getKorlapsForWorkzone
}) => {
    // ... (kode dari EditModal di file asli Anda)
    // Salin dan tempel seluruh kode komponen EditModal di sini
            ...
            {Object.keys(editForm).map((key) => {
              ...
              if (key === "sektor")
                return (
                  <div key={key} className="form-group">
                    ...
                    <select name={key} value={editForm[key] || ""} onChange={handleChange}>
              ...
              if (key === "workzone")
                return (
                  <div key={key} className="form-group">
                    <label>{key.replace(/_/g, " ")}:</label>
                    <select name={key} value={editForm[key] || ""} onChange={handleChange} disabled={!editForm.sektor}>
              ...
              if (key === "korlap")
                return (
                  <div key={key} className="form-group">
                    <label>{key.replace(/_/g, " ")}:</label>
                    <select name={key} value={editForm[key] || ""} onChange={handleChange} disabled={!editForm.workzone}>
              ...
              return (
                <div key={key} className="form-group">
                  <label>{key.replace(/_/g, " ")}:</label>
                  <input name={key} value={editForm[key] || ""} onChange={handleChange} disabled={key === "incident"} />
                </div>
              );
            })}
