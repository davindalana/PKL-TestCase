...
const InputWO = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!parsedData.length) throw new Error('Format data tidak valid atau kosong!')
  ...
  return (
    <div className="input-wo-container">
      <div className="page-header">
        ...
        <p>Paste data incident dari Excel (format tab-separated) dan simpan ke database MySQL</p>
      </div>
...
Format Hapus	INC38587292	01:56:01	WAJIB DIISI MSISDN CONTACT	2025-08-12 17:42:15	TIF HD DISTRICT MALANG	MALANG	BTU	BACKEND	..."
            ...
            <div className="textarea-info">
              <span>💡 Tips: Copy data dari Excel dan paste di sini (Ctrl+V)</span>
            </div>
          </div>
